                ...
                <ul class='nav navbar-nav navbar-right'>
                    <li class='dropdown'>
                        ...
                        <ul class='dropdown-menu dropdown-menu-right'>
                            <li>
                                <a href='/contas_contabeis/$id/edit'><i class='icon-pencil5'></i> Editar Categorias</a>
                            </li>
                             <li>
                                <a href='/contas_contabeis/$id/delete'><i class='icon-close2'></i> Deletar Categorias</a>
                            </li>
                        </ul>
                    </li>
                </ul>
